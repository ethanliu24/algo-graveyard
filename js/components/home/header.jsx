export default function Header() {
  return (
    <div className="rounded-3xl border-1 border-gray-100 p-8 bg-gray-50 shadow-sm max-md:p-4
      grid grid-cols-[4fr_5fr] grid-rows-[1fr_5fr] gap-x-8 grid-flow-col
      max-md:grid-cols-1 max-md:grid-rows-[fit-content(10px)_fit-content(10px)_fit-content(10px)] max-md:gap-y-1">
      <h2 className="text-2xl max-md:text-center max-md:text-base">Algo Graveyard</h2>
      <p className="text-xs font-light max-md:text-center max-md:text-[0.7rem]">
      ...
      <img src="./static/res/ghost.png" alt="crazy gpt generated ghost"
        className="rounded-2xl w-[100%] shadow-md row-span-2 my-auto max-md:row-span-1 max-md:mt-3" />
    </div>
  );
}
